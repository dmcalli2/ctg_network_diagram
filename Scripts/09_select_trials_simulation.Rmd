...
Select most extreme comparison, whterh it is different drug, different class or standard care/placebo. For the purposese of this analysis, it is enough to know that it is a drug comparison, no need to check if it is the same class or a different class.
...
Apply trial type criteria to diabetes trials.
